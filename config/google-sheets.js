...
['ages', 'neighborhoods', 'hospital'].forEach((title) => cytiesSheets.push({
  ...
  options: {
    spreadsheetId: '1LH6l05MUXcXi-dJH25sV7bbq_nWCeldlDy_Kf-cLLMk',
...
const cyties = ['chapeco', 'xaxim', 'oeste', 'blumenau', 'patoBranco', 'novaTebas', 'xanxere'];
...
['coredecXanxere', 'coredecChapeco', 'coredecMaravilha', 'coredecMiguel'].forEach((coredec) => {
  ['covid', 'confirmados', 'curados'].forEach((typeCase) => cytiesSheets.push({
    resolve: 'gatsby-source-google-sheets',
    options: {
